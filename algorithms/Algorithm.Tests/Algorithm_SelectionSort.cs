...
namespace Algorithm.Tests
{
    ...
    public class Algorithm_SelectionSort
    {
        ...
        public Algorithm_SelectionSort()
        {
        ...
        {
            var result = _algorithms.SelectionSort(new List<int> { 1, 3, 11, 2, 7, 5 });
        ...
        {
            var result = _algorithms.SelectionSort(new List<int> { 1, 7, 3, 9, 4 });
        ...
        {
            var result = _algorithms.SelectionSort(new List<int> { 51, 6, 29, 85, 1000, 7, 4, 360 });
